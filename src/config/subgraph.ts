import { ARBITRUM, ARBITRUM_GOERLI, ARBITRUM_SEPOLIA, AVALANCHE, AVALANCHE_FUJI, ETH_MAINNET } from "./chains";
...
const SUBGRAPH_URLS = {
  ...
  [ARBITRUM_SEPOLIA]: {
    syntheticsStats:
      "https://api.thegraph.com/subgraphs/name/tideassets/tperp-subgraph",
  },
